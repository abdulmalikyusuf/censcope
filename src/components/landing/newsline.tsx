    ...
    return <section id="newsline" className="flex flex-col gap-10 py-10">
        <header className="w-full flex gap-4 items-center justify-between flex-wrap px-md md:px-2xl">
            <div className="flex flex-col md:gap-4 ">
                ...
                <p className="text-md md:text-xl">
                    Find out about our <span className="text-cyan-600">field actions</span> through our reports, news, events,…
                </p>
            </div>
        ...
        <button className="mx-auto outline-none border-2 relative border-black hover:border-cyan-600 px-8 py-3 group transition-all before:absolute before:w-0 hover:before:w-full before:h-full before:bg-cyan-600 before:left-0 before:top-0 before:transition-all before:duration-300 before:-z-10">
            <span className="z-50 gap-2 flex items-center  group-hover:text-white">
                see all news <FaArrowRight className=" text-cyan-600 group-hover:text-white transition-all" />
            </span>
        </button>
    </section>
}