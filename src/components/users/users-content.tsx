    ...
    return (
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-y-8 lg:h-full pb-12">
            <div className="col-span-2 border-b border-gray-900/10 px-6 lg:h-full lg:overflow-y-auto">
                <h2 className="text-base/7 font-semibold text-gray-900">Put a face to your story</h2>
                <p className="mt-1 text-sm/6 text-gray-600 max-w-xs">
                    Adding a photo makes your presence more personal and relatable. Whether you&apos;re sharing ideas, publishing posts, or collaborating with others, a profile image helps people recognize and remember you. It’s a small detail that makes a big difference in how you&apos;re seen.
                </p>
                    ...
                    {users.map((user) => (
                        ...
                        >
                            <div className="flex items-center gap-3 min-w-0">
                                <div className="flex-shrink-0 flex justify-center items-center size-12 rounded-full overflow-hidden border-2 border-gray-200 group-hover:border-gray-300"> {/* Prevent shrinking */}
                                    {user.avatar ? (
                                        <Image
                                ...
                                <div className="min-w-0 flex-1">
                                    <p className="text-sm font-semibold text-gray-900 truncate"> {/* Truncate long names */}
                                        {user.name}
                                    </p>
                                    <p className="text-xs text-gray-600 truncate"> {/* Truncate long emails */}
                                        {user.email}
                                    </p>
                                </div>
                            </div>

                            <div className="flex items-center gap-1 opacity-0 transition-opacity duration-150 ease-in-out group-hover:opacity-100 focus-within:opacity-100"> {/* Icons container */}
                                <button
                                    type="button"
                                ...
                                <AlertDialog open={open} onOpenChange={setOpen}>
                                    ...
                                    <AlertDialogContent>
                                        <AlertDialogHeader>
                                            ...
                                            <AlertDialogDescription>
                                                This action cannot be undone. This will permanently delete user and restrict their access.
                                            </AlertDialogDescription>
                                        </AlertDialogHeader>
                                        <AlertDialogFooter>
            ...
            <div className="col-span-3 lg:h-full lg:overflow-y-auto relative group">
                {selectedUser && <div className="hidden group-hover:block absolute top-4 right-8">
                    <button
                        type="button"
