...
import React, { useState, ChangeEvent, Dispatch, SetStateAction, useCallback } from 'react'
...
export function AvatarUpload<T extends FieldValues>({
    ...
    const handleFileChange = useCallback(async (file: File) => {
        ...
        const options = {
            ...
            useWebWorker: true,
            onProgress: (progress: number) => progress < 100 ? setProgress(progress) : setProgress(null)
        }
        ...
        if (compressedBlob instanceof File) {
            ...
            console.log("Converted Blob to File:", fileForForm);
        }
